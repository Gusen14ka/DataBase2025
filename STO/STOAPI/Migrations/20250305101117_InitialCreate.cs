    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServiceToParts", x => new { x.ServiceId, x.PartId });
                    table.ForeignKey(
                        name: "FK_ServiceToParts_Parts_PartId",
                        column: x => x.PartId,
                        principalTable: "Parts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServiceToParts_Services_ServiceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ServiceToParts_PartId",
                table: "ServiceToParts",
                column: "PartId");
        }
